# Wesley Dias (1º Semestre ADS-B), Lista VI
...
def dormir(dia_semana, feriado):
    situ = False
    if feriado is True or dia_semana is False:
        situ = True
    return situ
...
def alunos_problema(a_sorri, b_sorri):
    situ = False
    if (a_sorri is True and b_sorri is True) or (a_sorri is False and b_sorri is False):
        situ = True
    return situ
